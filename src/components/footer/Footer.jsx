...
const Footer = () => {
  ...
  return (
    <>
        <footer className="relative font-philosopher bg-black text-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-12 lg:py-8 z-[-50]">
          ...
          <div className="w-full lg:w-2/6 lg:mx-4 lg:pr-8">            
            ...
            <Link to="/">
                  <img
                      src={Logo}
                      alt="logo"
                      className="w-full relative z-8 drop-shadow-lg opacity-45 rounded-xl mt-12"
                  />
          </Link>
          <ul className="mt-4 flex items-center justify-center">
              <li>
                <Link to="/" target="_blank" title="" className=''>
                  <svg
            ...
            <ul className="mt-4">
              ...
              <li className="mt-4">
                ...
                >
                  ...
                  <span className="ml-3">+91-9211727756</span>
                </Link>
              </li>
              <li className="mt-4">
                <Link
                ...
                >
                  ...
                  <span className="ml-3">rexinternational@gmail.com</span>
                </Link>
              </li>
            </ul>
          </div>
          <div className="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
            <ul className=''>
            {
                    MenuLinks.map((data, index)=>(
                        <li key={index}>
                            <Link to={data.link} className='py-20 opacity-75 font-semibold hover:text-red-500 dark:hover:text-red-500 hover:underline duration-200 text-lg '>{" "}{data.name}</Link>
                        </li>
                ))}
            </ul>
        ...
        <p className="text-sm text-gray-400 mt-6 text-center">
          Copyright &copy; 2024 All Rights Reserved by Rex International
        </p>
