...
const Kitchencare = () => {
    const kitchenCareProducts = products["Kitchen Care"];
  ...
  return (
    <>
        ...
        {
            kitchenCareProducts.map((data, index)=>(
                <div key={index} className="w-64 flex flex-col items-center mb-12 shadow-md bg-white rounded-xl p-2">
                
                <button>
                    <img className="p-4 rounded-t-lg" src={data.image} alt="productimage" />
                </button>
                
                <div className="px-5 pb-5">
                    <Link to="/kitchendetail">
